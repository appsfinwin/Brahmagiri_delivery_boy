...
import com.example.runner.Adapters.LedgerAdapter;
...
import com.example.runner.databinding.FragmentCompletedBinding;
...
public class CompletedFragment extends Fragment {
    ...
    private void doFetchLedger(String startdate, String enddate) {
        ...
        Call<ResponseLedger>call=apiService.doFetchLedger(mAccesstoken,"test",jsonObject);
