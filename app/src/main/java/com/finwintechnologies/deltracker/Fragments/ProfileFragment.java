...
import com.finwintechnologies.deltracker.Activities.ChangePassword;
...
import com.finwintechnologies.deltracker.databinding.FragmentProfileBinding;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.chngpwd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
