...
public class MyFirebaseMessagingService  extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
     ...
     //   sendNotification("test");
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            sendNotification("New Order Assigned");
    ...
    public void onNewToken(String token) {
       ...
       // sendNotification("kjsdkjashjdas");
    }
    // [END on_new_token]
    ...
    private void sendNotification(String messageBody) {
        //  MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.notitone);
        //   mediaPlayer.start();
        ...
        final Uri NOTIFICATION_SOUND_URI = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + BuildConfig.APPLICATION_ID + "/" + R.raw.notitone);
        final long[] VIBRATE_PATTERN = {0, 500};


        Uri defaultSoundUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.notitone);
